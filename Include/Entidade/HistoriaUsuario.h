...
private:
    Codigo codigo;         ///< Objeto de domínio que representa o identificador único da história.
    Nome nome;             ///< Objeto de domínio que atua como o título ou designação curta da história.
    Papel papel;           ///< Objeto de domínio que indica a função de quem necessita da funcionalidade (o "quem").
    Texto valor;           ///< Objeto de domínio que descreve o benefício de negócio esperado (o "por que").
    Texto acao;            ///< Objeto de domínio que descreve a atividade ou funcionalidade desejada (o "o que").
    Tempo estimativa;      ///< Objeto de domínio que quantifica o esforço ou duração esperada para conclusão.
    Prioridade prioridade; ///< Objeto de domínio que indica o nível de urgência para a execução.
    Estado estado;         ///< Objeto de domínio que sinaliza a situação de progresso atual (ex: a fazer, fazendo, feito).
