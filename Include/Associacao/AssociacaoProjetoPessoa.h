...
private:
    Codigo codigoProjeto; ///< Objeto de domínio que representa o identificador único do projeto (macroescopo).
    Email emailPessoa;    ///< Objeto de domínio que representa o identificador único (e-mail) do colaborador.
